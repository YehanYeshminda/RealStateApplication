...
import { Observable, delay, of, retry, timeout } from 'rxjs';
...
export class TopbarComponent implements OnInit {
  ...
  notifications$: Observable<Root<AllNotifications[]>> = of();
  ...
  ngOnInit(): void {
    ...
    // this.notifications$ = this.notificationService.getAllNotificationsForUser().pipe(
    //   delay(2000),
    //   timeout(5000),
    //   retry(3)
    // );
