...
// types
import { Email, OutlookEmails } from './email.model';

// data
import { EMAILS } from './data';
import { Observable, of } from 'rxjs';
import { Root } from 'src/app/shared/models/base';
import { EmailHttpService } from './services/email-http.service';
...
export class InboxComponent implements OnInit {
  ...
  constructor (private eventService: EventService, private emailHttpService: EmailHttpService) { }
 ...
 */
  ...
  loadAllEmails() {
    this.emailValues$ = this.emailHttpService.getAllEmails();
  }
}
